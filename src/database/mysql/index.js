...
class DBConn {
	...
	connect = async () => {
		try {
			...
			console.log("MYSQL-connection: Connecting");
			...
			const sequelize = new Sequelize(process.env.MYSQL_DATABASE, process.env.MYSQL_USERNAME, process.env.MYSQL_PASSWORD, conf);
			const database = {
				models: {
